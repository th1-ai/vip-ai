---
name: vip-ai
description: Run VIP AI ("The Insider") — One system that makes every VIP feel known.. Use when the user asks to run the agent, check what is waiting for review, approve or reject a draft, or asks how the agent is doing. Trigger phrases: "run The Insider", "/vip-ai", "check the queue", "what is waiting for me", "approve that draft".
---

# VIP AI

Runs VIP AI and works its review queue. Everything happens from the repo
